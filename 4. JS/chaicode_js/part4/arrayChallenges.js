/*
for multiline comments - use "shift + option + a"
*/
...
let JSONString = JSON.stringify(popularTeas)
let softCopyTeas = JSON.parse(JSONString);

popularTeas.push("orange tea");
